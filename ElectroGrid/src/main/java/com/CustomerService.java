...
public class CustomerService {
	...
	public String insertCustomer(@FormParam("customerName") String customerName,
			@FormParam("customerNic") String customerNic, @FormParam("customerEmail") String customerEmail,
			@FormParam("customerPhone") String customerPhone, @FormParam("customerAddress") String customerAddress) {
		String output = customerObj.insertCustomer(customerName, customerNic, customerEmail, customerPhone,
				customerAddress);
		return output;
	}
	...
	public String updateCustomer(String customerData) {
		...
		String output = customerObj.updateCustomer(customerId, customerName, customerNic, customerEmail, customerPhone,
				customerAddress);
		return output;
	}
